        ...
        <div className='py-20'>
            ...
            <div className='flex sm:gap-7 gap-5 overflow-auto pt-10 text-center text-black md:p-10 pl-5'>
                <div className='bg-white sm:rounded-[10px] rounded-[5px] flex flex-col gap-5 min-w-[200px]'>
                    <Image src={sellers} width={1000} height={1000} className='rounded-t-[10px] md:h-[200px] h-[150px]  ' alt='' />
                ...
                <div className='bg-white sm:rounded-[10px] rounded-[5px]  flex flex-col gap-5 min-w-[200px]'>
                    <Image src={creator} width={1000} height={1000} className='rounded-t-[10px] md:h-[200px] h-[150px]' alt='' />
                    <div className='px-5 pb-10'>
                ...
                <div className='bg-white sm:rounded-[10px] rounded-[5px]  flex flex-col gap-5 min-w-[200px]'>
                    <Image src={partner} width={1000} height={1000} className='rounded-t-[10px] md:h-[200px] h-[150px]' alt='' />
                    <div className='px-5 pb-10'>
                ...
                <div className='bg-white sm:rounded-[10px] rounded-[5px]  flex flex-col gap-5 min-w-[200px]'>
                    <Image src={lady} width={1000} height={1000} className='rounded-t-[10px] md:h-[200px] h-[150px]' alt='' />
                    <div className='px-5 pb-10'>
