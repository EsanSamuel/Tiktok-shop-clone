        ...
        <div className='sm:p-10 p-5 py-20'>
            <div className='md:p-20  pb-10'>
                <div className='text-center'>
                    ...
                    <p className='md:text-[20px] text-[16px] sm:pt-10 pt-5 '>It enables merchants and creators to showcase and sell products for the TikTok community to discover and purchase directly through a complete in-app experience.</p>
                </div>
            </div>
                ...
                {serviceItems.map((item) => (
                    <div key={item.id}>
                        <div className='flex flex-col sm:gap-3 gap-6 text-center text-white'>
                            <video src={item.video} className='sm:w-[350px] sm:h-[600px] rounded-[15px] w-full h-[600px]  ' />
